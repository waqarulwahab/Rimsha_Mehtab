...
class AboutMe(models.Model):
    name          = models.CharField(max_length=255, default='Rimsha Mehtab',    null=True, blank=True)
    title         = models.CharField(max_length=255, default='Interior Designer', null=True, blank=True)
    birthday      = models.DateField()
    website       = models.URLField(max_length=255, null=True, blank=True)
    phone         = models.CharField(max_length=20, default='+92 3368297079')
    city          = models.CharField(max_length=100)
    age           = models.IntegerField()
    degree        = models.CharField(max_length=100)
    email         = models.EmailField(default='rimshamehtab432@gmail.com')
